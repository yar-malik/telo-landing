...
import AutoPlayVideo from "@/components/auto-play-vedio"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-6">
                ...
                <div className="text-2xl text-gray-600 leading-relaxed">
                  Specialized in{" "}
                  <DynamicText
                    words={["Sales Excellence", "Smart Recruitment", "Customer Service"]}
                    className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600"
                  />
                </div>

                <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                  Transform your business with AI employees that work 24/7, never take breaks, and deliver exceptional
                ...
                <div className="flex items-center space-x-8 py-8">
                  <div className="flex items-center">
                    ...
                    <span className="ml-4 text-gray-600 font-medium">500+ companies trust us</span>
                  </div>
                  <div className="flex items-center">
                    <div className="flex">
                      {[1, 2, 3, 4, 5].map((i) => (
        ...
        <section className="relative -mt-20 z-10">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { number: "500+", label: "Active Clients", icon: Users, color: "from-blue-500 to-blue-600" },
                { number: "24/7", label: "Availability", icon: Clock, color: "from-indigo-500 to-indigo-600" },
                { number: "95%", label: "Accuracy Rate", icon: CheckCircle, color: "from-purple-500 to-purple-600" },
                { number: "60min", label: "Setup Time", icon: Zap, color: "from-pink-500 to-pink-600" },
        ...
        {/* Video Section with Modern Layout */}
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                See Our AI in <span className="text-blue-600">Action</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Watch how our AI employees handle real conversations with natural, human-like interactions.
              </p>
            </div>
            <div className="max-w-4xl mx-auto">
              <AutoPlayVideo videoLink="https://connectaisolutions.com/wp-content/uploads/2025/02/ai-agent-4.mp4" />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Meet the AI employees that will revolutionize your business operations and drive unprecedented growth.
              </p>
            </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8 hover:shadow-xl transition-all duration-300">
                <div className="grid lg:grid-cols-3 gap-8 items-center">
                  <div className="text-center lg:text-left">
                    ...
                    <p className="text-blue-600 font-semibold mb-2">AI Sales Executive</p>
                    <Link
                  ...
                  <div className="lg:col-span-2">
                    <p className="text-gray-700 text-lg leading-relaxed mb-6">
                      Generates qualified leads, conducts personalized outreach, and nurtures prospects through your
                      entire sales funnel with human-like conversations.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-600">Personalized Outreach</span>
                      </div>
                      <div className="flex items-center">
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-3xl p-8 hover:shadow-xl transition-all duration-300">
                <div className="grid lg:grid-cols-3 gap-8 items-center">
                  <div className="text-center lg:text-left">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Alex</h3>
                    <p className="text-indigo-600 font-semibold mb-2">AI Recruitment Agent</p>
                    <Link
                      href="/recruitment"
                  ...
                  <div className="lg:col-span-2">
                    <p className="text-gray-700 text-lg leading-relaxed mb-6">
                      Screens candidates, schedules interviews, and manages your entire recruitment pipeline with
                      precision and efficiency.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-center">
                        <Users className="w-5 h-5 text-indigo-500 mr-2" />
                        <span className="text-gray-600">Candidate Screening</span>
                      </div>
                      <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-600">Candidate Communication</span>
                      </div>
                      <div className="flex items-center">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-3xl p-8 hover:shadow-xl transition-all duration-300">
                <div className="grid lg:grid-cols-3 gap-8 items-center">
                  <div className="text-center lg:text-left">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Sophia</h3>
                    <p className="text-purple-600 font-semibold mb-2">AI Receptionist</p>
                    <Link
                      href="/receptionist"
                  ...
                  <div className="lg:col-span-2">
                    <p className="text-gray-700 text-lg leading-relaxed mb-6">
                      Handles calls, books appointments, and provides exceptional customer service around the clock with
        ...
        <section className="py-20 bg-gradient-to-br from-slate-50 to-blue-50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From setup to deployment, we'll have your AI employee working in under an hour.
              </p>
            </div>
                  ...
                  {[
                    {
                      ...
                      desc: "Select from our specialized AI employees based on your business needs",
                      img: "/how-it-works/one.jpg",
                      color: "from-blue-500 to-blue-600",
                    },
                    {
                      step: "2",
                      title: "Quick Integration Setup",
                      desc: "Connect with your existing tools and customize the AI to match your brand",
                      img: "/how-it-works/two.jpg",
                      color: "from-indigo-500 to-indigo-600",
                    },
                    {
                      step: "3",
                      title: "Go Live & Start Scaling",
                      desc: "Test, deploy, and watch your AI employee start delivering results immediately",
                      img: "/how-it-works/three.jpg",
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Why Choose Our <span className="text-blue-600">AI Employees</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Experience the future of work with AI that's indistinguishable from human interaction.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
              <div>
                <h3 className="text-4xl font-bold text-gray-900 mb-6">
                  Always <span className="text-blue-600">Available</span>, Always{" "}
                  <span className="text-indigo-600">Professional</span>
                </h3>
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Our AI employees deliver human-like conversations that feel natural and engaging. They're available
                  24/7, never need breaks, and consistently provide exceptional service.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1 relative">
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-400/20 to-purple-400/20 rounded-3xl transform -rotate-3"></div>
                <Image
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-4xl font-bold text-gray-900 mb-6">
                  Fully <span className="text-blue-600">Customizable</span> to Your Brand
                </h3>
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Tailor every aspect of your AI employee to match your brand voice, industry requirements, and specific
                  business processes.
                </p>
                <div className="grid grid-cols-2 gap-6 mb-8">
                  {[
        ...
        <section className="py-20 bg-gradient-to-br from-slate-50 to-blue-50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Connect with your favorite tools and platforms. Our AI employees work with your existing workflow.
              </p>
            </div>
